...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout.addWidget(self.list_apps, 4, 5, 4, 1)
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/images/folder-48.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btn_workspace.setIcon(icon)
        ...
        self.gridLayout.addWidget(self.lbl_apps, 3, 5, 1, 1)
        ...
        self.gridLayout.addWidget(self.btn_add_application, 8, 5, 1, 1)
        ...
        self.gridLayout.addWidget(self.web_engine, 1, 1, 6, 1)
        ...
        self.gridLayout.addWidget(self.txt_ticket_notes, 7, 1, 2, 1)
        ...
        self.gridLayout.addWidget(self.tickets_list_widget, 0, 0, 9, 1)
